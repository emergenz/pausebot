...
app.get('/', function (req, res) {
    ...
    res.render('index', {pageTitle: 'Pausebot - We pause your TikToks- just in time', pageDescription: 'Pausebot - Your TikTok Pausebot and Downloader', keyWords: 'TikTok pausebot, Tik Tok, Pausebot, pausebot.com, tiktok pause, TikTok downloader, mp4 Tik Tok downloader', ogTitle: 'Pausebot - We pause your TikToks - just in time', ogDescription: 'Your online TikTok Pausebot & Downloader', twitterTitle: 'Pausebot - just in time', twitterDescription: 'Your online TikTok Pausebot & Downloader', title1: 'Your TikTok', title2: 'Pausebot', buttonText: 'Get Photo', actionVar: '/', textBox: 'Do you want to be the CEO of pausing TikToks? Do you dislike the pausebots offered on TikTok? Then this is the right website for you. We at pausebot.com have developed sophisticated algorithms for pausing TikToks for you - just in time. To do so you simply have to copy a TikTok link (E.g: https://vm.tiktok.com/123456) and paste the link in the field above. Then, hit the "Get Photo" button and wait for our servers to process your request. The processing time ranges from 5 to 10 seconds, depending on your Internet speed and the length of the video. After we have processed the video the paused image will appear on your screen without a watermark. Glad we could help! If you want to express your gratitude in financial form, please take a look at the bottom of this page or visit our ”Contact us” page. If you are not satisfied with the results of our services, please checkout our Contact page. br You can also download the TikTok video directly to your device via our download service and manually pause the video yourself. If you have encountered any problems or issues with our service we advise you to contact us via our Contact page. If you have any questions regarding your privacy rules please take a look at our ”Privacy” page.'});
    systemSync("rm -f *.jpg");
    systemSync("rm -f *.mp4");
    systemSync("rm -f *.txt");
})
