...
export declare const getHashtagInfo: (input: string, options?: Options | undefined) => Promise<Challenge>;
export declare const getUserProfileInfo: (input: string, options?: Options | undefined) => Promise<UserData>;
export declare const signUrl: (input: string, options?: Options | undefined) => Promise<string>;
export declare const getVideoMeta: (input: string, options?: Options | undefined) => Promise<PostCollector>;
export declare const video: (input: string, options?: Options | undefined) => Promise<any>;
